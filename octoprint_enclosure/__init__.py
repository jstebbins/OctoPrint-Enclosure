...
class EnclosurePlugin(octoprint.plugin.StartupPlugin, octoprint.plugin.TemplatePlugin, octoprint.plugin.SettingsPlugin,
        ...
        try:
            if self.development_mode:
                ...
                if sensor['temp_sensor_type'] in ["11", "22", "2302"]:
                    ...
                    airquality = 0
                elif sensor['temp_sensor_type'] == "sht30":
                    temp, hum = self.read_sht30_temp(sensor['temp_sensor_address'], sensor['temp_sensor_i2cbus'])
                    airquality = 0
    ...
    def read_sht30_temp(self, address, i2cbus):
        try:
